namespace day09.Book
{
    partial class Login
    {
        ...
        private void InitializeComponent()
        {
            ...
            // label2
            // 
            label2.Location = new Point(287, 173);
            label2.Name = "label2";
            ...
            // input1
            // 
            input1.Location = new Point(376, 156);
            input1.Name = "input1";
            input1.PlaceholderText = "请输入用户名";
            input1.Size = new Size(312, 60);
            input1.TabIndex = 4;
            // 
            // button1
            // 
            ...
            // input2
            // 
            input2.Location = new Point(376, 238);
            input2.Name = "input2";
            input2.PlaceholderText = "请输入密码";
            input2.Size = new Size(312, 60);
            input2.TabIndex = 4;
            // 
            // label4
            // 
            label4.Location = new Point(287, 444);
            label4.Name = "label4";
            ...
            // button2
            // 
            button2.Location = new Point(447, 439);
